//// [tests/cases/conformance/jsxGeneric/jsxGenericTest14.tsx] ////
...
/* @jsx-intrinsic-factory $JD.createElement */
Object.defineProperty(exports, "__esModule", { value: true });
const $JD = require("./dom");
function test() {
    return $JD.createElement("div", { class: "test2", onkeydown: (ev) => { ev.preventDefault(); } },
        $JD.createElement("span", null, "test"),
        $JD.createElement("span", null));
}
