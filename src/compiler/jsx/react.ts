            ...
            if (parent && parent.openingElement === openingLikeElement && parent.children.length > 0) {
                ...
                if (!hasSpreadAnyType && jsxChildrenPropertyName && jsxChildrenPropertyName !== "") {
                    ...
                    childrenPropSymbol.type = childrenTypes.length === 1 ? childrenTypes[0] :
                        childrenContextualType && typeChecker.forEachType(childrenContextualType, typeChecker.isTupleLikeType) ? typeChecker.createTupleType(childrenTypes, /*elementFlags*/ undefined, /*readonly*/ false, /*namedMemberDeclarations*/ undefined) :
        ...
        function getIntrinsicAttributesTypeFromJsxOpeningLikeElement(node: JsxOpeningLikeElement): Type {
            ...
            if (!links.resolvedJsxElementAttributesType) {
                ...
                if (links.jsxFlags & JsxFlags.IntrinsicNamedElement) {
                    return links.resolvedJsxElementAttributesType = typeChecker.getTypeOfSymbol(symbol);
                }
                else if (links.jsxFlags & JsxFlags.IntrinsicIndexedElement) {
                    return links.resolvedJsxElementAttributesType =
                        typeChecker.getIndexTypeOfType(typeChecker.getDeclaredTypeOfSymbol(symbol), IndexKind.String)!;
                }
                else {
